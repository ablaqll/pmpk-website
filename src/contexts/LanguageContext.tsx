...
export const translations: Translations = {
  ...
  'about.diag': { kz: 'Обследование', ru: 'Обследование', en: 'Diagnostics' },
  'about.diagDesc': { kz: 'Кешенді тексеру', ru: 'Комплексное обследование', en: 'Complex Diagnostics' },
  ...
  'about.correct': { kz: 'Бағдарламалар', ru: 'Программы', en: 'Correction' },
  'about.correctDesc': { kz: 'Оқыту бағдарламасын анықтау', ru: 'Определение программы обучения', en: 'Correction Classes' },
  ...
  // Vacancies page
  'vacancies.title': { kz: 'Бос жұмыс орындары', ru: 'Вакансии', en: 'Vacancies' },
  ...
  'vacancies.viewHere': { kz: 'Жарияланған бос жұмыс орындарын осы жерден көре аласыз', ru: 'Опубликованные вакансии можете посмотреть здесь', en: 'You can view published vacancies here' },
  'vacancies.goToEnbek': { kz: 'enbek.kz сайтына өту', ru: 'Перейти на enbek.kz', en: 'Go to enbek.kz' },
